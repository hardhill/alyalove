<template>
    <div class="row">
        ...
        <div class="toast-container pb-2 mt-5 mx-auto" style="min-width: 100%;" v-for="(comment,index) in comments" :key="index">
            <div class="toast showing" style="min-width: 100%;">
                <div class="toast-header">
                    <img src="https://via.placeholder.com/48/5F113B/FFFFFF/?text=User" class="rounded me-2" alt="...">
